...
'''You can then add a button to your GUI to call the get_netstat() function, like so:

bash'''

# create a button to retrieve network statistics
netstat_button = tk.Button(root, text="Get Network Statistics", command=get_netstat)
netstat_button.pack(pady=10)
# start the main loop
root.mainloop()